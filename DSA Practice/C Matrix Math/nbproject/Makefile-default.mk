...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/MatrixMath.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/MatrixMath.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/mml_test.o: mml_test.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/mml_test.o.d 
	@${RM} ${OBJECTDIR}/mml_test.o 
	@${FIXDEPS} "${OBJECTDIR}/mml_test.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -Wall -MMD -MF "${OBJECTDIR}/mml_test.o.d" -o ${OBJECTDIR}/mml_test.o mml_test.c    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -mdfp=${DFP_DIR}  
	
${OBJECTDIR}/MatrixMath.o: MatrixMath.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/MatrixMath.o.d 
	@${RM} ${OBJECTDIR}/MatrixMath.o 
	@${FIXDEPS} "${OBJECTDIR}/MatrixMath.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -Wall -MMD -MF "${OBJECTDIR}/MatrixMath.o.d" -o ${OBJECTDIR}/MatrixMath.o MatrixMath.c    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -mdfp=${DFP_DIR}  
...
dist/${CND_CONF}/${IMAGE_TYPE}/MatrixMath.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}\\xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/MatrixMath.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
