...
public interface CruxListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CruxParser#forStmt}.
	 * @param ctx the parse tree
	 */
	void enterForStmt(CruxParser.ForStmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link CruxParser#forStmt}.
	 * @param ctx the parse tree
	 */
	void exitForStmt(CruxParser.ForStmtContext ctx);
	/**
