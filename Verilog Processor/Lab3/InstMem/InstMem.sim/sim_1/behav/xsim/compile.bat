...
REM
REM Generated by Vivado on Mon Feb 28 14:55:29 -0800 2022
...
echo "xvlog --incr --relax -prj InstMem_tb_vlog.prj"
call xvlog  --incr --relax -prj InstMem_tb_vlog.prj -log xvlog.log
