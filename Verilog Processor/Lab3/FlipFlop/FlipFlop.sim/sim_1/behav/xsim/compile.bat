...
REM
REM Generated by Vivado on Sun Feb 13 22:19:22 -0800 2022
...
echo "xvlog --incr --relax -prj FlipFlop_tb_vlog.prj"
call xvlog  --incr --relax -prj FlipFlop_tb_vlog.prj -log xvlog.log
