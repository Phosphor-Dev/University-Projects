...
REM
REM Generated by Vivado on Fri Jan 21 19:15:27 -0800 2022
...
echo "xvlog --incr --relax -prj FourBFA_Test_vlog.prj"
call xvlog  --incr --relax -prj FourBFA_Test_vlog.prj -log xvlog.log
