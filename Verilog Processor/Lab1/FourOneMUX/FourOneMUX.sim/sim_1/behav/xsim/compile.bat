...
REM
REM Generated by Vivado on Fri Jan 21 22:07:47 -0800 2022
...
echo "xvlog --incr --relax -prj FourOneMUX_Test_vlog.prj"
call xvlog  --incr --relax -prj FourOneMUX_Test_vlog.prj -log xvlog.log
