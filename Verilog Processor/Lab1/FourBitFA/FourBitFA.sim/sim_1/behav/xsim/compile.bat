...
REM
REM Generated by Vivado on Fri Jan 21 21:46:26 -0800 2022
...
echo "xvlog --incr --relax -prj FourBitFA_Test_vlog.prj"
call xvlog  --incr --relax -prj FourBitFA_Test_vlog.prj -log xvlog.log
