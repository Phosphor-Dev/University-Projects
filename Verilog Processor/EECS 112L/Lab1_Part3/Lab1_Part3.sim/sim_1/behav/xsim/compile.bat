...
REM
REM Generated by Vivado on Thu Oct 06 22:12:19 -0700 2022
...
echo "xvlog --incr --relax -prj tb_dff_PC_vlog.prj"
call xvlog  --incr --relax -prj tb_dff_PC_vlog.prj -log xvlog.log
