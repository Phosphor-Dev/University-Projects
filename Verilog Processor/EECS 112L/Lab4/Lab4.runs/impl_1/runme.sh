...
HD_PWD='C:/Users/Steven/Desktop/UCI/Verilog/EECS 112L/Lab4/Lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mips_32.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mips_32.tcl -notrace
