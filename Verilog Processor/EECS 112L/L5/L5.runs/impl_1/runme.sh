...
HD_PWD='C:/Users/Steven/Desktop/EECS 112L/L5/L5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log behav_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source behav_counter.tcl -notrace
