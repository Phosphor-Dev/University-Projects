...
HD_PWD='C:/Users/Steven/Desktop/EECS 112L/Lab5/Lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log behav_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source behav_counter.tcl
