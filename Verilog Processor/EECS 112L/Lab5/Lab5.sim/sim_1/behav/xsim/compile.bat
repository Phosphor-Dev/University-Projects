...
REM
REM Generated by Vivado on Sat Dec 03 00:38:49 -0800 2022
...
echo "xvlog --incr --relax -prj mips_32_vlog.prj"
call xvlog  --incr --relax -prj mips_32_vlog.prj -log xvlog.log
