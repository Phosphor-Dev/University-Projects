...
REM
REM Generated by Vivado on Sun Jan 30 23:04:34 -0800 2022
...
echo "xvlog --incr --relax -prj alu_32_tb_vlog.prj"
call xvlog  --incr --relax -prj alu_32_tb_vlog.prj -log xvlog.log
