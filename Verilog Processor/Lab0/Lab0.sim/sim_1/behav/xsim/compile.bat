...
REM
REM Generated by Vivado on Fri Jan 21 12:56:35 -0800 2022
...
echo "xvlog --incr --relax -prj decoder_2to4_vlog.prj"
call xvlog  --incr --relax -prj decoder_2to4_vlog.prj -log xvlog.log
