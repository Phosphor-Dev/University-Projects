...
REM
REM Generated by Vivado on Sun Mar 13 21:31:21 -0700 2022
...
echo "xvlog --incr --relax -prj ALUController_vlog.prj"
call xvlog  --incr --relax -prj ALUController_vlog.prj -log xvlog.log
