...
REM
REM Generated by Vivado on Sun Mar 13 21:37:33 -0700 2022
...
echo "xvlog --incr --relax -prj dp_tb_top_vlog.prj"
call xvlog  --incr --relax -prj dp_tb_top_vlog.prj -log xvlog.log
