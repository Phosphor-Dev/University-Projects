...
REM
REM Generated by Vivado on Mon Feb 28 17:39:31 -0800 2022
...
echo "xvlog --incr --relax -prj DataMem_vlog.prj"
call xvlog  --incr --relax -prj DataMem_vlog.prj -log xvlog.log
