...
SOURCEFILES_QUOTED_IF_SPACED=Message.c Negotiation.c Uart1.c OledDriver.c Oled.c FieldOled.c CircularBuffer.c BOARD.c Ascii.c Lab09_main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Message.o ${OBJECTDIR}/Negotiation.o ${OBJECTDIR}/Uart1.o ${OBJECTDIR}/OledDriver.o ${OBJECTDIR}/Oled.o ${OBJECTDIR}/FieldOled.o ${OBJECTDIR}/CircularBuffer.o ${OBJECTDIR}/BOARD.o ${OBJECTDIR}/Ascii.o ${OBJECTDIR}/Lab09_main.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Message.o.d ${OBJECTDIR}/Negotiation.o.d ${OBJECTDIR}/Uart1.o.d ${OBJECTDIR}/OledDriver.o.d ${OBJECTDIR}/Oled.o.d ${OBJECTDIR}/FieldOled.o.d ${OBJECTDIR}/CircularBuffer.o.d ${OBJECTDIR}/BOARD.o.d ${OBJECTDIR}/Ascii.o.d ${OBJECTDIR}/Lab09_main.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Message.o ${OBJECTDIR}/Negotiation.o ${OBJECTDIR}/Uart1.o ${OBJECTDIR}/OledDriver.o ${OBJECTDIR}/Oled.o ${OBJECTDIR}/FieldOled.o ${OBJECTDIR}/CircularBuffer.o ${OBJECTDIR}/BOARD.o ${OBJECTDIR}/Ascii.o ${OBJECTDIR}/Lab09_main.o

# Source Files
SOURCEFILES=Message.c Negotiation.c Uart1.c OledDriver.c Oled.c FieldOled.c CircularBuffer.c BOARD.c Ascii.c Lab09_main.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/BattleBoats.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/BattleBoats.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  Lab9SupportLib.a  
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -g -mdebugger -D__MPLAB_DEBUGGER_PK3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/BattleBoats.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}    Lab9SupportLib.a      -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)   -mreserve=data@0x0:0x1FC -mreserve=boot@0x1FC02000:0x1FC02FEF -mreserve=boot@0x1FC02000:0x1FC024FF  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,-D=__DEBUG_D,--defsym=__MPLAB_DEBUGGER_PK3=1,--defsym=_min_heap_size=28000,--defsym=_min_stack_size=900,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -mdfp=${DFP_DIR}
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/BattleBoats.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  Lab9SupportLib.a 
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/BattleBoats.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}    Lab9SupportLib.a      -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=_min_heap_size=28000,--defsym=_min_stack_size=900,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -mdfp=${DFP_DIR}
